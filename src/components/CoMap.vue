      ...
      <div class="col-6">
        <q-card>
          <q-card-section>
            ...
            <div class="row">
              <div class="col">
                <div class="infoDeparments"  @click="showDepartmentInfoModal('Amazónas')">
                  <div
                ...
                <div class="infoDeparments" @click="showDepartmentInfoModal('Antioquía')">
                  <div
                    class="departmentColor"
                    style="background-color: #ffff00"
                  ></div>
                ...
                <div class="infoDeparments" @click="showDepartmentInfoModal('Arauca')">
                  <div
                    class="departmentColor"
                    style="background-color: #ffff00"
                  ></div>
                ...
                <div class="infoDeparments" @click="showDepartmentInfoModal('Atlántico')">
                  <div
                    class="departmentColor"
                    style="background-color: #ffff00"
                  ></div>
                ...
                <div class="infoDeparments" @click="showDepartmentInfoModal('Bogotá')">
                  <div
                    class="departmentColor"
                    style="background-color: #ffff00"
                  ></div>
                  <div><span>Bogotá</span></div>
                </div>
                <div class="infoDeparments" @click="showDepartmentInfoModal('Bolívar')">
                  <div
                    class="departmentColor"
                    style="background-color: #ffff00"
                  ></div>
                ...
                <div class="infoDeparments" @click="showDepartmentInfoModal('Boyacá')">
                  <div
                    class="departmentColor"
                    style="background-color: #ffff00"
                  ></div>
                ...
                <div class="infoDeparments" @click="showDepartmentInfoModal('Caldas')">
                  <div
                    class="departmentColor"
                    style="background-color: #ffff00"
                  ></div>
                ...
                <div class="infoDeparments" @click="showDepartmentInfoModal('Caquetá')">
                  <div
                    class="departmentColor"
                    style="background-color: #ffff00"
                  ></div>
                ...
                <div class="infoDeparments" @click="showDepartmentInfoModal('Casanare')">
                  <div
                    class="departmentColor"
                    style="background-color: #ffff00"
                  ></div>
                ...
                <div class="infoDeparments" @click="showDepartmentInfoModal('Cauca')">
                  <div
                    class="departmentColor"
                    style="background-color: #ffff00"
                  ></div>
              ...
              <div class="col">
                <div class="infoDeparments" @click="showDepartmentInfoModal('Cesar')">
                  <div
                    class="departmentColor"
                    style="background-color: #ffff00"
                  ></div>
                ...
                <div class="infoDeparments" @click="showDepartmentInfoModal('Chocó')">
                  <div
                    class="departmentColor"
                    style="background-color: #ffff00"
                  ></div>
                ...
                <div class="infoDeparments" @click="showDepartmentInfoModal('Córdoba')">
                  <div
                    class="departmentColor"
                    style="background-color: #ffff00"
                  ></div>
                ...
                <div class="infoDeparments" @click="showDepartmentInfoModal('Cundinamarca')">
                  <div
                    class="departmentColor"
                    style="background-color: #ffff00"
                  ></div>
                  <div><span>Cundinamarca</span></div>
                </div>

                <div class="infoDeparments" @click="showDepartmentInfoModal('Guainía')">
                  <div
                    class="departmentColor"
                    style="background-color: #ffff00"
                  ></div>
                ...
                <div class="infoDeparments" @click="showDepartmentInfoModal('Guaviare')">
                  <div
                    class="departmentColor"
                    style="background-color: #ffff00"
                  ></div>
                  <div><span>Guaviare</span></div>
                </div>

                <div class="infoDeparments" @click="showDepartmentInfoModal('Huila')">
                  <div
                    class="departmentColor"
                    style="background-color: #ffff00"
                  ></div>
                  <div><span>Huila</span></div>
                </div>

                <div class="infoDeparments" @click="showDepartmentInfoModal('La Guajira')">
                  <div
                    class="departmentColor"
                    style="background-color: #ffff00"
                  ></div>
                  <div><span>La Guajira</span></div>
                </div>

                <div class="infoDeparments" @click="showDepartmentInfoModal('Magdalena')">
                  <div
                    class="departmentColor"
                    style="background-color: #ffff00"
                  ></div>
                  <div><span>Magdalena</span></div>
                </div>

                <div class="infoDeparments" @click="showDepartmentInfoModal('Meta')">
                  <div
                    class="departmentColor"
                    style="background-color: #ffff00"
                  ></div>
                ...
                <div class="infoDeparments" @click="showDepartmentInfoModal('Nariño')">
                  <div
                    class="departmentColor"
                    style="background-color: #ffff00"
                  ></div>
                  <div><span>Nariño</span></div>
                </div>
              </div>
              <div class="col">
                <div class="infoDeparments" @click="showDepartmentInfoModal('Norte de Santander')">
                  <div
                    class="departmentColor"
                    style="background-color: #ffff00"
                  ></div>
                  <div><span>Norte de Santander</span></div>
                </div>
                <div class="infoDeparments" @click="showDepartmentInfoModal('Putumayo')">
                  <div
                    class="departmentColor"
                    style="background-color: #ffff00"
                  ></div>
                  <div><span>Putumayo</span></div>
                </div>
                <div class="infoDeparments" @click="showDepartmentInfoModal('Quindío')">
                  <div
                    class="departmentColor"
                    style="background-color: #ffff00"
                  ></div>
                  <div><span>Quindío</span></div>
                </div>
                <div class="infoDeparments" @click="showDepartmentInfoModal('Risaralda')">
                  <div
                    class="departmentColor"
                    style="background-color: #ffff00"
                  ></div>
                  <div><span>Risaralda</span></div>
                </div>
                <div class="infoDeparments" @click="showDepartmentInfoModal('San Andrés')">
                  <div
                    class="departmentColor"
                    style="background-color: #ffff00"
                  ></div>
                  <div><span>San Andrés</span></div>
                </div>
                <div class="infoDeparments" @click="showDepartmentInfoModal('Santander')">
                  <div
                    class="departmentColor"
                    style="background-color: #ffff00"
                  ></div>
                  <div><span>Santander</span></div>
                </div>
                <div class="infoDeparments" @click="showDepartmentInfoModal('Sucre')">
                  <div
                    class="departmentColor"
                    style="background-color: #ffff00"
                  ></div>
                  <div><span>Sucre</span></div>
                </div>
                <div class="infoDeparments" @click="showDepartmentInfoModal('Tolima')">
                  <div
                    class="departmentColor"
                    style="background-color: #ffff00"
                  ></div>
                  <div><span>Tolima</span></div>
                </div>
                <div class="infoDeparments" @click="showDepartmentInfoModal('Valle del Cauca')">
                  <div
                    class="departmentColor"
                    style="background-color: #ffff00"
                  ></div>
                  <div><span>Valle del Cauca</span></div>
                </div>
                <div class="infoDeparments" @click="showDepartmentInfoModal('Vaupés')">
                  <div
                    class="departmentColor"
                    style="background-color: #ffff00"
                  ></div>
                ...
                <div class="infoDeparments" @click="showDepartmentInfoModal('Vichada')">
                  <div
                    class="departmentColor"
                    style="background-color: #ffff00"
                  ></div>
                  <div><span>Vichada</span></div>
                </div>
              </div>
            </div>
          </q-card-section>
      ...
      <div class="col-6">
        <div class="svg-wrapper">
          <svg
            ...
            class="wisconsin"
          >
            <a xlink:title="Amazonas">
              <path
                @mouseover="showDepartmentInfo('Amazonas')"
                @click="showDepartmentInfoModal('Amazonas')"
            ...
            <a xlink:title="Antioquia">
              <path
                @mouseover="showDepartmentInfo('Antioquia')"
                @click="showDepartmentInfoModal('Antioquia')"
            ...
            <a xlink:title="Arauca">
              <path
                @mouseover="showDepartmentInfo('Arauca')"
                @click="showDepartmentInfoModal('Arauca')"
            ...
            <a xlink:title="Atlántico">
              <path
                @mouseover="showDepartmentInfo('Atlántico')"
                @click="showDepartmentInfoModal('Atlántico')"
            ...
            <a xlink:title="Bolívar">
              <path
                @mouseover="showDepartmentInfo('Bolívar')"
                @click="showDepartmentInfoModal('Bolívar')"
            ...
            <a xlink:title="Boyacá">
              <path
                @mouseover="showDepartmentInfo('Boyacá')"
                @click="showDepartmentInfoModal('Boyacá')"
            ...
            <a xlink:title="Cauca">
              <path
                @mouseover="showDepartmentInfo('Cauca')"
                @click="showDepartmentInfoModal('Cauca')"
            ...
            <a xlink:title="Cesar">
              <path
                @mouseover="showDepartmentInfo('Cesar')"
                @click="showDepartmentInfoModal('Cesar')"
            ...
            <a xlink:title="Chocó">
              <path
                @mouseover="showDepartmentInfo('Chocó')"
                @click="showDepartmentInfoModal('Chocó')"
            ...
            <a xlink:title="Caldas">
              <path
                @mouseover="showDepartmentInfo('Caldas')"
                @click="showDepartmentInfoModal('Caldas')"
            ...
            <a xlink:title="Córdoba">
              <path
                @mouseover="showDepartmentInfo('Córdoba')"
                @click="showDepartmentInfoModal('Córdoba')"
            ...
            <a xlink:title="Caquetá">
              <path
                @mouseover="showDepartmentInfo('Caquetá')"
                @click="showDepartmentInfoModal('Caquetá')"
            ...
            <a xlink:title="Casanare">
              <path
                @mouseover="showDepartmentInfo('Casanare')"
                @click="showDepartmentInfoModal('Casanare')"
            ...
            <a xlink:title="Cundinamarca">
              <path
                @mouseover="showDepartmentInfo('Cundinamarca')"
                @click="showDepartmentInfoModal('Cundinamarca')"
            ...
            <a xlink:title="Bogotá">
              <path
                @mouseover="showDepartmentInfo('Bogotá')"
                @click="showDepartmentInfoModal('Bogotá')"
            ...
            <a xlink:title="Guainía">
              <path
                @mouseover="showDepartmentInfo('Guainía')"
                @click="showDepartmentInfoModal('Guainía')"
            ...
            <a xlink:title="Guaviar">
              <path
                @mouseover="showDepartmentInfo('Guaviar')"
                @click="showDepartmentInfoModal('Guaviar')"
            ...
            <a xlink:title="Huila">
              <path
                @mouseover="showDepartmentInfo('Huila')"
                @click="showDepartmentInfoModal('Huila')"
            ...
            <a xlink:title="La Guajira">
              <path
                @mouseover="showDepartmentInfo('La Guajira')"
                @click="showDepartmentInfoModal('La Guajira')"
            ...
            <a xlink:title="Magdalena">
              <path
                @mouseover="showDepartmentInfo('Magdalena')"
                @click="showDepartmentInfoModal('Magdalena')"
            ...
            <a xlink:title="Meta">
              <path
                @mouseover="showDepartmentInfo('Meta')"
                @click="showDepartmentInfoModal('Meta')"
            ...
            <a xlink:title="Nariño">
              <path
                @mouseover="showDepartmentInfo('Nariño')"
                @click="showDepartmentInfoModal('Nariño')"
            ...
            <a xlink:title="Norte de Santander">
              <path
                @mouseover="showDepartmentInfo('Norte de Santander')"
                @click="showDepartmentInfoModal('Norte de Santander')"
            ...
            <a xlink:title="Putumayo">
              <path
                @mouseover="showDepartmentInfo('Putumayo')"
                @click="showDepartmentInfoModal('Putumayo')"
            ...
            <a xlink:title="Quindío">
              <path
                @mouseover="showDepartmentInfo('Quindío')"
                @click="showDepartmentInfoModal('Quindío')"
            ...
            <a xlink:title="Risaralda">
              <path
                @mouseover="showDepartmentInfo('Risaralda')"
                @click="showDepartmentInfoModal('Risaralda')"
            ...
            <a xlink:title="Santander">
              <path
                @mouseover="showDepartmentInfo('Santander')"
                @click="showDepartmentInfoModal('Santander')"
            ...
            <a xlink:title="Sucre">
              <path
                @mouseover="showDepartmentInfo('Sucre')"
                @click="showDepartmentInfoModal('Sucre')"
            ...
            <a xlink:title="San Andrés, Providencia y Santa Catalina">
              <path
                @mouseover="showDepartmentInfo('San Andrés, Providencia y Santa Catalina')"
                @click="showDepartmentInfoModal('San Andrés, Providencia y Santa Catalina')"
            ...
            <a xlink:title="Tolima">
              <path
                @mouseover="showDepartmentInfo('Tolima')"
                @click="showDepartmentInfoModal('Tolima')"
            ...
            <a xlink:title="Valle del Cauca">
              <path
                @mouseover="showDepartmentInfo('Valle del Cauca')"
                @click="showDepartmentInfoModal('Valle del Cauca')"
            ...
            <a xlink:title="Vichada">
              <path
                @mouseover="showDepartmentInfo('Vichada')"
                @click="showDepartmentInfoModal('Vichada')"
            ...
            <a xlink:title="Vaupés">
              <path
                @mouseover="showDepartmentInfo('Vaupés')"
                @click="showDepartmentInfoModal('Vaupés')"
...
import planetChartData from "src/boot/planet-data.js";
...
export default {
  ...
  methods: {
    ...
    showDepartmentInfo: function (title) {
      this.active = true;
      this.title = title;
    ...
    showDepartmentInfoModal: function (title) {
      this.active = true;
      this.title = title;
    ...
    hideDepartmentInfo: function (title) {

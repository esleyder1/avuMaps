      ...
      <div class="col-7">
        <div class="svg-wrapper">
          ...
          >
            ...
            <a xlink:title="Distrito Capital de Bogotá">
              <path
                @mouseover="showDepartmentInfo('Distrito Capital de Bogotá')"
            ...
            <a xlink:title="San Andrés, Providencia y Santa Catalina">
              <path
                @mouseover="
                  showDepartmentInfo('San Andrés, Providencia y Santa Catalina')
                "
